...
if (puzzleGroup) puzzleGroup.remove();
      ...
      setTimeout(()=>{
        ...
        setTimeout(()=>{
          ...
          // baseHeight usato come offset verticale (puoi regolarlo)
          const baseHeight = 0;
          ...
          border1960.setAttribute('color', '#ffffff'); // bordo bianco
          ...
          borderFacade.setAttribute('color', '#ffffff'); // bordo bianco
